...
describe("URI", function()
	...
	it("Should decode percent characters", function()
		assert.same({host="example.com", path="/space character"}, uri:match "example.com/space%20character")
		assert.same({host="example.com", path="/null\0byte"}, uri:match "example.com/null%00byte")

		assert.falsy(uri:match "example.com/bad%x0percent")
	end)
